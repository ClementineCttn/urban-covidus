...
to setup
  ...
  set essential-industry 50
  set proba-secondary-home 5
  set share-collective-housing 50
  set n-cities 8
  set link-radius 12
  set max-pop-city 700
  set infection-proba 5
  set average-recovery-time 8
  set proba-dying 0.1
  set average-days-between-shopping 4
  set radius-movement 4
  set shop-per-100-inhab 2
...
to go
  ...
  if all? people [alive? = 0]
    ...
    ifelse maisons-secondaires?[print "Confinement activé. Ceux qui ont une résidence secondaire y vont."][print "Confinement activé."]
    ]

  update-health

  ifelse maisons-secondaires? [
  go-to-work
  go-shopping
  ifelse lockdown? = 0 [
    go-home
...
559
323
% oui parmi défavorisés
precision ((100 * count people with [class = \"poor\" and activity-at-infection = \"work\" ] ) /  count people with [class = \"poor\"]) 2
17
1
11
...
560
375
% oui parmi privilégiés
precision ((100 * count people with [class = \"rich\" and activity-at-infection = \"work\" ] ) /  count people with [class = \"rich\"]) 2
17
1
11
...
598
163
Combien de gens sont décédés jusque là ?
13
0.0
1
...
This model represents the spread of an epidemic by contact between agents of three "social" classes in cities of the same system. 

## HOW IT WORKS

Agents go to work, shop and come back home. Each of these places are opportunities for contact. A lockdown is put in place once 10 deaths have been reached. Some people live in collective housing and can get infected at home whereas other live isolated. Some people can work from home during lockdown while other cannot. "Priviledged" people live isolated and work from home, "working class" people live in collective housing and keep working outside of home during lock down.

## HOW TO USE IT

Press "Initialise" to setup the world, and "Simulate" to start the simulation.

## THINGS TO NOTICE

Look at the variation of the infection and death rates in the graphs by social class.

## THINGS TO TRY

You can activate the option for secondary houses.

## CREDITS AND REFERENCES

Clémentine Cottineau. clementine.cottineau@gmail.com
@#$#@#$#@
default
true
0
